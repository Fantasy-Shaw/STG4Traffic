...
args.add_argument('--nb_block', default=config['model']['nb_block'], type=eval)
args.add_argument('--K', default=config['model']['K'], type=eval)
args.add_argument('--nb_chev_filter', default=config['model']['nb_chev_filter'], type=eval)
args.add_argument('--nb_time_filter', default=config['model']['nb_time_filter'], type=eval)
args.add_argument('--num_of_week', default=config['model']['num_of_week'], type=eval)
args.add_argument('--num_of_day', default=config['model']['num_of_day'], type=eval)
args.add_argument('--num_of_hour', default=config['model']['num_of_hour'], type=eval)
